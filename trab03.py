...
if __name__ == "__main__":
    ...
    aruco_positions = []
    aruco_positions.append(aruco_center_positions("data/videos/camera-00.mp4"))
    aruco_positions.append(aruco_center_positions("data/videos/camera-01.mp4"))
    aruco_positions.append(aruco_center_positions("data/videos/camera-02.mp4"))
    aruco_positions.append(aruco_center_positions("data/videos/camera-03.mp4"))
    ...
    for frame in range(frame_count):
        added_points = 0
        for cam in range(4):
            if aruco_positions[cam][frame] is not None:
                if added_points == 0:
